...
int main(void)
{
	// enable semihosting to view printf statements also need monitor arm semihosting enable in startup run commands
	...
	{	// Wait for button press
		...
		readByte[length+1] = '\0'; //to print string, must be null terminated

		// printf("Data: %s",readByte);
